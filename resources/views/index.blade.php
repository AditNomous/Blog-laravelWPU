...
<body style="background: url('img/bg.jpeg') no-repeat center center fixed, linear-gradient(to right, #3b82f6, #8b5cf6); background-size: cover;">
    ...
    <div class="container mx-auto mt-12 flex flex-col lg:flex-row px-6">
     ...
     @guest   <!-- Left Side (Get Started Button) -->
