                    ...
                    @foreach ($yourposts as $post)
                        <article
                            ...
                            <div class="flex justify-between items-center mb-5 text-gray-500">
                                ...
                                <a class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-3 py-2.5 text-center  " href="/edit/{{$post->id}}">Edit</a>
                                <a href="/delete/{{$post->id}}"
                                    class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-3 py-2.5 text-center  ">
                                    Delete </a>
                            </div>
